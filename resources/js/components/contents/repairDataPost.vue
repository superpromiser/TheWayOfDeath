      ...
      <v-col cols="12" class="d-flex" @click="showDetail(content)">
        ...
        <div class="ml-2 d-flex flex-column">
          <div class="d-flex align-center mb-auto">
            <p class="mb-0 font-size-0-95 font-weight-bold primary-font-color">
              维修工单
            </p>
            <v-chip
              class="ml-2"
              ...
              label
              text-color="white"
              v-if="content.repairdata.status == 'cancel'"
            >
            ...
            <v-chip
              ...
              label
              text-color="white"
              v-if="content.repairdata.status == 'Undone'"
            >
            ...
            <v-chip
              ...
              label
              text-color="white"
              v-if="content.repairdata.status == 'progress'"
            >
            ...
            <v-chip
              ...
              label
              text-color="white"
              v-if="content.repairdata.status == 'done'"
            >
            ...
            <v-chip
              ...
              label
              text-color="white"
              v-if="content.repairdata.status == 'completed'"
            >

<template>
	<div v-click-outside="closeMenu" class="quick-menu" ref="quickMenu" :style="quickMenuStyle">
        ...
        <div class="sub-menu mo-glow d-flex align-center justify-center" @click="publish" :style="getSubMenu(0)">
        ...
        <div class="sub-menu mo-glow d-flex align-center justify-center" @click="draft" :style="getSubMenu(1)">
            <v-icon ref="icon" color="#7879ff">mdi-file-document-edit-outline</v-icon>
            <span>模板</span>
        </div>
        <div class="sub-menu mo-glow d-flex align-center justify-center" @click="$router.go(-1)" :style="getSubMenu(2)">
        ...
        <v-btn  v-if="isOpenedMenu" fab @click="toggleMenu" dark class="menu" color="#eb5846">
...
<script>
  ...
  computed:{
    ...
    quickMenuStyle(){
      ...
      bottomPosition={bottom:'100px'},
      leftPosition = {left:'30px'},
      rightPosition = {right:'12px'}
  ...
  data(){
    return{
      ...
      subMenu3:[[["-120","0"],["-85","-85"],["0","-120"]],[["0","-160"],["113","-113"],["160","0"]],[["0","160"],["113","113"],["160","0"]],[["-160","0"],["-113","113"],["0","160"]]],
      subMenu2:[[["-100","0"],["0","-100"]],[["0","-100"],["100","0"]],[["0","100"],["100","0"]],[["-100","0"],["0","100"]]]
    }
  },
  methods:{
    getSubMenu(n){

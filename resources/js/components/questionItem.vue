  ...
  <v-container v-if="$isMobile()" class="bg-white pa-0">
    <v-container v-if="isShareView" class="pa-0">
      <v-row
        :class="
          isAnnouncement
            ? 'ma-0 text-area-without-nav-bottom-announcement'
            : 'ma-0 text-area-without-nav-bottom'
        "
      ...
      >
        ...
        <v-col cols="12" class="pa-0 pb-16">
          <v-container class="pa-0 pb-16">
            ...
            <v-row class="ma-0">
              <v-col
                v-for="(imgUrl, index) in contentData.imgUrl"
                :key="index"
                cols="12"
                sm="4"
                md="3"
            ...
            <v-row class="ma-0">
              <v-col
                v-for="(video, index) in contentData.videoUrl"
                :key="index"
                cols="12"
                sm="4"
                md="4"
                ...
                class="position-relative py-1"
              >
                <v-card class="d-flex align-center mo-glow-bg" flat tile>
                  <img
            ...
            <v-row class="ma-0">
              <v-col
                v-for="(other, index) in contentData.otherUrl"
                :key="index"
                cols="12"
                sm="4"
                md="4"
      ...
      <v-row
        class="ma-0 position-fixed-bottom-0 w-100"
  ...
  <v-container v-else>
    ...
    <v-row>
      <v-col
        ...
        class="position-relative"
      >
        <v-card class="d-flex align-center " color="grey lighten-2" flat tile>
          <img
            :src="`${baseUrl}/asset/img/upload_video_img.png`"
            alt="upload-video-icon"
            class="uploaded-video-icon ma-2"

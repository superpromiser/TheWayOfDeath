...
export default [
  ...
  { path: '/admin/userlist', name: 'admin.userlist', component: page('admin/userList.vue'),
    children : [
      ...
      {path:'employee', name:'userlist.employee',component:page('admin/userList/employee.vue')},
  ...
  {path:'/schoolSpace/:schoolId/post/voting', name:'posts.voting', component:page('school/posts/voting/new.vue'),
    children:[
      {path:'templateList', name:'voting.tempList', component:page('school/posts/voting/templateList.vue')}
    ]
  },
  ...
  {path:'/schoolSpace/:schoolId/post/announcement', name:'posts.announcement', component:page('school/posts/announcement/new.vue'),
    children:[
      {path:'templateList', name:'anouncement.templateList',component:page('school/posts/announcement/templateList.vue')}
    ]
  },
  ...
  {path:'/schoolSpace/:schoolId/post/regname', name:'posts.regname', component:page('school/posts/regname/new.vue'),
    children:[
      {path:'templateList',name:'regname.templateList',component:page('school/posts/regname/templateList.vue')}
    ]
  },
  {path:'/schoolSpace/:schoolId/post/regname/newTemplate',name:'regname.newTemplate',component:page('school/posts/regname/newTemplate.vue')},
  ...
  {path:'/classSpace/:schoolId/:gradeId/:lessonId/post/homework', name:'posts.Chomework', component:page('class/posts/homework/index.vue'),
    children:[
      ...
      {path:'templateList',name:'Chomework.templateList',component:page('class/posts/homework/templateList.vue')}
    ]
  },
  {path:'/classSpace/:schoolId/:gradeId/:lessonId/post/homework/newTemplate', name:'Chomework.newTemp', component:page('class/posts/homework/newTemplate.vue')},

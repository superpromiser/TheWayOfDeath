...
import {getHomeworkData} from '~/api/questionnaire';
...
export default {
    ...
    methods:{
        async infiniteHandler($state){
            ...
            let vm = this;
            await getHomeworkData({page:this.pageOfContent,schoolId:this.currentPath.params.schoolId,lessonId:this.currentPath.params.lessonId})
            .then(res=>{

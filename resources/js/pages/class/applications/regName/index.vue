...
export default {
    ...
    methods:{
        async infiniteHandler($state){
            ...
            let vm = this;
            await getRegname({page:this.pageOfContent,schoolId:this.currentPath.params.schoolId,lessonId:this.currentPath.params.lessonId})
            .then(res=>{
        ...
        post(){
            this.$router.push({name:"posts.CregName"})
        }
    }
}
</script>

<template>
  <v-container v-if="$isMobile()">
      ...
      <v-col cols="12" sm="6" md="4">
        ...
        >
          ...
          <v-card>
              ...
              >
                ...
                <v-list-item v-if="newSignFlag">
                  <v-text-field
                    ...
                    label="公告标题"
                  ></v-text-field>
                  <v-btn color="deep-purple lighten-2" text @click="addNewName">
                    {{ lang.ok }}
                  </v-btn>
                </v-list-item>
              </v-list-item-group>
            ...
            <v-card-actions>
              <v-btn color="deep-purple lighten-2" text @click="chooseSignName">
                {{ lang.ok }}
              </v-btn>
    ...
    <quick-menu
      ...
      @clickPublish="publishcampusData"
...
export default {
  ...
  methods: {
    ...
    async publishcampusData() {
      ...
      await createNotification(this.notificationData)
        .then(res => {
    ...
    chooseSignName() {
      if (this.indexOfSignName == 0) {
        ...
        this.notificationData.signName = this.signNameItems[

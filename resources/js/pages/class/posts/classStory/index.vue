      ...
      >
        <template v-slot:activator="{ on, attrs }">
          ...
          >
            ...
            {{
              shareData.publishType == "pub"
                ? "公开"
                : shareData.publishType == "pvt"
                ? "私密"
  ...
  methods: {
    ...
    async submit() {
      ...
      if (this.shareData.content[0].text.trim() == "") {
        return this.$snackbar.showMessage({
          content: this.lang.classStory + this.lang.requireContent,
          color: "error"
        });
      }
      if (this.shareData.content[0].imgUrl.length == 0) {
        return this.$snackbar.showMessage({
          content: this.lang.classStory + this.lang.requireAvatar,
          color: "error"
        });
      }
    ...
    selectPublishType(val) {
      console.log(val, this.shareData.content[0]);
      if (val == "spec") {
        if (this.shareData.content[0].text.trim() == "") {

  ...
  methods: {
    ...
    async submit() {
      ...
      if(this.shareData.content[0].text.trim() == ''){
          return this.$snackbar.showMessage({content: this.lang.classStory+this.lang.requireContent, color: "error"})
      }
      if(this.shareData.content[0].imgUrl.length == 0){
          return this.$snackbar.showMessage({content: this.lang.classStory+this.lang.requireAvatar, color: "error"})
      }

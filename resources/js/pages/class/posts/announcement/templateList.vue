    ...
    <v-container class="pa-0" v-if="$isMobile()">
        <v-container class="pa-0 h-100 bg-white mb-16 pb-3 pt-12" >
            <v-row class="ma-0 bg-white justify-center position-sticky-top-0" >
                ...
                <p class="mb-0 font-size-0-95 font-weight-bold pa-3" >{{lang.announcement}}模板清单</p>
...
export default {
    ...
    methods:{
        ...
        selTemp(tempData){
            ...
            // return
            this.$router.push({name:'posts.Cannouncement',query:{tempData:JSON.stringify(tempData.content)}})
        },

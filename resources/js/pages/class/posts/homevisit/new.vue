<template>
  <v-container v-if="$isMobile()">
    ...
    <v-row class="ma-0 mo-glow mt-5 mb-16">
    ...
    >
      <v-container class="pa-0">
        <v-card>
          ...
          <v-row
            class="ma-0"
            v-for="(item, i) in visitData.description"
            :key="i"
          >
    ...
    <v-container class="px-10 z-index-2 banner-custom">
      <v-row>
        ...
        <v-col cols="12" md="4" class="d-flex align-center justify-end">
          <v-btn text color="#7879ff" @click="templateList">
...
export default {
  ...
  methods: {
    ...
    async publishcampusData() {
      ...
      await createHomeVisit(this.visitData)
        .then(res => {

        ...
        <v-container class="pt-0 px-0 h-100 bg-white mb-16 pb-10-px">
            <v-row class="ma-0 bg-white justify-center position-sticky-top-0" >
                ...
                <div class="d-flex align-center position-absolute put-align-center" style="right: 0px; top:50%">
                    <v-btn @click="allowVacation" :loading="isAllow" small text color="#49d29e" >
                        通过
                    </v-btn>
            ...
            <v-row class="ma-0">
                ...
                <v-col cols="12" class="d-flex justify-space-between align-start">
                    ...
                    <p class="mb-0 font-size-0-8 width-100-without-68-px text-wrap text-right">{{newVacationData.reason}}</p>
                    <!-- <v-textarea
                        class="mt-0 pt-0"
                        solo
                ...
                <v-col cols="12" sm="6" class="d-flex justify-space-around">
                    ...
                    <p class="mr-auto  mb-0 font-size-0-8" v-if="newVacationData.reasonFlag == false">病假</p>

      ...
      >
        <template v-slot:activator="{ on, attrs }">
          ...
          >
            ...
            {{
              homeworkData.publishType == "all"
                ? "公开"
                : homeworkData.publishType == "me"
                ? "私密"
        ...
        <div class="pa-3 text-right">
          <v-radio-group
            class="mt-0 pt-0"
            v-model="homeworkData.publishType"
    ...
    <div v-if="showRule == false">
      ...
      <v-container class="px-10">
        ...
        <v-row class="ma-0 hover-cursor-point" v-ripple @click="setRule">
          <v-col
            cols="12"
            class="d-flex align-center justify-space-between py-6"
          >
            <p class="mb-0">发布规则</p>
    ...
    submit() {
      ...
      if (this.homeworkData.subjectName == "") {
        return this.$snackbar.showMessage({
          content: this.lang.homework + this.lang.requireSubjectName,
          color: "error"
        });
      }
      if (this.homeworkData.homeworkType == "") {
        return this.$snackbar.showMessage({
          content: this.lang.homework + this.lang.requireSubjectType,
          color: "error"
        });
      }
      ...
      if (this.homeworkData.content[0].text.trim() == "") {
        return this.$snackbar.showMessage({
          content: this.lang.homework + this.lang.requireContent,
          color: "error"
        });
      }
      this.isSubmit = true;
      ...
      createHomeworkData({
        ...
        deadline:
          this.homeworkData.deadline == ""
            ? null
            : this.TimeViewSam(this.homeworkData.deadline),

  ...
  <v-container class="pa-0">
    <v-banner class=" mb-10 z-index-2" color="white" sticky elevation="20">
      <div class="d-flex align-center">
        <v-avatar class="ma-3 ml-3" size="50" tile>
          <v-img
            :src="`${baseUrl}/asset/img/icon/问卷 拷贝.png`"
            alt="postItem"
          ></v-img>
        </v-avatar>
        <h2>问卷</h2>
      ...
      <template v-slot:actions>
        <v-btn text color="#7879ff">
          可用模板 0， 草稿 0
        </v-btn>
        <v-btn dark color="#7879ff" class="mr-md-8">
          提交
        </v-btn>
      </template>
    </v-banner>
        ...
        <v-col cols="12" sm="6" md="4">
          ...
          >
            ...
            >
              ...
              <v-btn text color="#7879ff" @click="$refs.menu.save(date)">
                {{ lang.ok }}
              </v-btn>
            </v-date-picker>
          </v-menu>
...
export default {
  ...
  mounted() {
    this.newQuestionnaireData.content.singleContentDataArr.push(
      this.singleData
    );
    ...
    this.newQuestionnaireData.content.scoringQuestoinsDataArr.push(
      this.scoringData
    );

<template>
  <v-container>
    <v-row>
      ...
      <v-col>
        <v-card
          ...
          v-if="
            (user.role.id == 7 &&
              user.lessonId == currentPath.params.lessonId) ||
              user.role.id == 1 ||
              user.role.id == 2
          "
          @click="action('invite')"
    ...
    <v-row v-else>
      ...
      <v-col
        v-for="user in userList.teachers"
        :key="user.id"
        cols="12"
        sm="6"
        md="4"
        lg="2"
        @click="selMember(user)"
      ...
      >
        <v-card>
          <div class="mx-auto text-center">
            ...
            <v-avatar v-else size="60" class="ma-5">
            ...
            <v-list>
              ...
              <v-list-item-content>
                <v-list-item-title
                  v-text="pnEncrypt(user.phoneNumber)"
                ></v-list-item-title>
              </v-list-item-content>
            </v-list>
          </div>
      ...
      <v-col
        v-for="user in userList.students"
        :key="user.id"
        cols="12"
        sm="6"
        md="4"
      ...
      <v-col
        v-for="user in userList.parents"
        :key="user.id"
        cols="12"
        sm="6"
        md="4"

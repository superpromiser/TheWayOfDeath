      ...
      <v-col cols="12" class="d-flex align-center ">
        ...
        >
          <v-card>
            ...
            <v-card-actions>
              <v-spacer></v-spacer>
              <v-btn color="blue darken-1" text @click="closeAddSessionDialog">
                {{ lang.cancel }}
              </v-btn>
              <v-btn
                color="blue darken-1"
...
export default {
  ...
  methods: {
    ...
    async deleteItemConfirm() {
      ...
      await deleteSubject({ id: this.editedItem.id })
        .then(res => {
          //console.log(res.data)
        })
        .catch(err => {
    ...
    async save() {
      ...
      if (this.editedIndex > -1) {
        ...
        await updateSubject(this.editedItem)
          .then(res => {
            //console.log(res.data)
      ...
      //save scheduleData
        ...
        await createSubject(this.editedItem)
          .then(res => {
            //console.log(res.data)

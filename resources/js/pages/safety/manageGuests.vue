                        ...
                        <div class="d-flex ">
                            ...
                            <v-container>
                                <v-row class="ma-0 d-flex align-center justify-space-between">
                                    ...
                                    <v-chip v-if="guest.status == 'allow'" color="#49d29e" outlined>致谢</v-chip>
                        ...
                        <v-expand-transition>
                            <div v-if="hover" class="transition-fast-in-fast-out position-absolute d-flex align-center justify-center guest-control-hover">
                                <div class="pa-2 px-10">
                                    <div>
                                        <v-btn fab x-large color="#49d29e" dark @click="allowGuest(guest)" :disabled="guest.status == 'allow'" :loading="isUpdatingGuestAllow">
                                            同意
                                        </v-btn>
                                    </div>
                                    <div class="mt-7">
